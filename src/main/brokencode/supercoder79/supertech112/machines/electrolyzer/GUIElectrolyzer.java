...
import supercoder79.supertech112.api.machine.gui.MachineGUI;
...
public class GUIElectrolyzer extends MachineGUI {
    ...
    public GUIElectrolyzer(Container container, InventoryPlayer playerInv, TileEntityElectrolyzer tileEntity) {
        super(container, playerInv, tileEntity, new ResourceLocation(SuperTech.MODID, "textures/gui/gui_electrolyzer.png"), "Electrolyzer");
        te = tileEntity;
    }
    @Override
