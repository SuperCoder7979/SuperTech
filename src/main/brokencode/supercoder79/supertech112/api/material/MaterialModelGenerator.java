...
public class MaterialModelGenerator {
    ...
    public static final String TEX_NAME = "supertech112:items/materials/";
    public static final String BLOCK_NAME = "supertech112:blocks/ores/";

    public static final String LOC_NAME = "item.supertech112.";
    public static final String BLOCK_LOC_NAME = "item.supertech112.";
    public static ArrayList<String> locs = new ArrayList<>();

    public static void main(String[] args) throws Exception {
        File assets = new File("src/main/resources/assets/supertech112");
        ...
        for (String o: new String[] {"ore_lead", "ore_ruby", "ore_sapphire", "ore_bauxite", "ore_copper"}) {
            data = BLOCKSTATE_ORE;
            data = data.replace("$NAME$", "supertech112:blocks/ores/" + o);
